            ...
            <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
                <div class="d-flex flex-column-fluid">
                    <div class="container">
                        ...
                        <form id="update-order" action="<%= request.getContextPath()%>/UpdateFeedback" method="POST">
                            <button class="btn btn-primary">Send Staff Comment<i class="bi bi-check"></i></button>
                            <div>
                                                    ...
                                                    <div class="form-row">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                %>
                                                                <textarea class="form-control" placeholder="Feedback here" name="staffComment" cols="30" rows="10"></textarea>
                                                                <%
                                                                    }
                                                                %>
                                                            </div>
